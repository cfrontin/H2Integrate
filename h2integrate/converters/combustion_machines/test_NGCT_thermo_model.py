...
from h2integrate.converters.combustion_machines.NGCT_thermo_model import GE_7EA_NGCT_2014
from h2integrate.converters.combustion_machines.NGCT_thermo_model import GE_7FA05_NGCT
from h2integrate.converters.combustion_machines.NGCT_thermo_model import NGCT
from h2integrate.converters.combustion_machines.NGCT_thermo_model import NGCTResult
from h2integrate.converters.combustion_machines.NGCT_thermo_model import compute_compressor_outlet_state_isentropic
from h2integrate.converters.combustion_machines.NGCT_thermo_model import compute_compressor_work_rate
from h2integrate.converters.combustion_machines.NGCT_thermo_model import compute_heat_transfer
from h2integrate.converters.combustion_machines.NGCT_thermo_model import compute_turbine_outlet_state_isentropic
from h2integrate.converters.combustion_machines.NGCT_thermo_model import compute_turbine_work_rate
from h2integrate.converters.combustion_machines.NGCT_thermo_model import humidity_ratio_to_water_mass_fraction
from h2integrate.converters.combustion_machines.NGCT_thermo_model import make_humid_air_mixture
...
def test_helper_sign_conventions(iso_ambient_state):
	...
	wdot_compressor = compute_compressor_work_rate(iso_ambient_state, compressed, isentropic_efficiency=0.85)
